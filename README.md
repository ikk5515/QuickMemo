...
- Firebase Auth, Firestore, Firestore Rules, Firestore Emulator
...
- `date-holidays` 기반 한국 공휴일 계산과 보완 공휴일 매핑
...
`npm run test:rules`는 Firebase Firestore Emulator와 Java Runtime이 필요합니다.
